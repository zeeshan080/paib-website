...
import { Upload, X, Plus, Loader2, User, Link, Github, Linkedin } from "lucide-react"
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-slate-400 text-center">Image cannot be more than 1 MB</p>
              </div>
            </div>
